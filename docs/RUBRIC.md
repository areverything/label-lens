...
This doc is the **rubric and the coverage tracker**: the points reference plus the [coverage checklist](#coverage-checklist) below, which tracks where each deliverable is answered and its status. The answers themselves live in [deliverables.md](./deliverables.md).
...
Every scored deliverable, its points, where it's answered in [deliverables.md](./deliverables.md), and its status. `✅` done · `🔨` drafted / in progress · `☐` not started. This is the single tracker; deliverables.md holds the answers themselves.

| Task | Pts | Deliverable | Where | Status |
|---|--:|---|---|---|
| 1 | 1 | 1-sentence problem (no solution) | [§1.1](./deliverables.md#11-the-problem-one-sentence) | ✅ |
| 1 | 3 | Why it's a problem (who / what / today / gap) | [§1.2](./deliverables.md#12-why-this-is-a-problem) | ✅ |
| 1 | 3 | Current-workflow diagram | [§1.3](./deliverables.md#13-how-the-user-solves-this-today) | ✅ |
| 1 | 2 | Eval questions / input-output pairs | [§1.4](./deliverables.md#14-questions-we-evaluate-against) | ✅ |
| 2 | 1 | Solution in one sentence | [§2.1](./deliverables.md#21-the-solution-one-sentence) | ✅ |
| 2 | 7 | Infra diagram + one-line why per component | [§2.2](./deliverables.md#22-infrastructure) | ✅ |
| 2 | 7 | Agent-workflow diagram + 1-2 paragraphs | [§2.3](./deliverables.md#23-agent-workflow) | ✅ |
| 3 | 5 | All data sources + external APIs + their use | [§3.2](./deliverables.md#32-data-sources-and-external-apis) | ✅ |
| 3 | 5 | Default chunking strategy + why | [§3.1](./deliverables.md#31-chunking-strategy) | ✅ |
| 4 | 15 | End-to-end prototype + deploy with a front end | [§4](./deliverables.md#task-4-end-to-end-agentic-rag-prototype) | ✅ |
| 5 | 2 | Test dataset | [§5.1](./deliverables.md#51-test-dataset) | ✅ |
| 5 | 10 | Evaluation harness | [§5.2](./deliverables.md#52-evaluation-harness) | ✅ |
| 5 | 3 | Conclusions on performance | [§5.3](./deliverables.md#53-conclusions) | ✅ |
| 6 | 6 | Advanced retriever + why | [§6.1](./deliverables.md#61-advanced-retriever-cross-encoder-reranker) | ✅ |
| 6 | 2 | Before/after comparison table | [§6.2](./deliverables.md#62-beforeafter-results) | ✅ |
| 6 | 6 | One other improvement + eval evidence | [§6.3](./deliverables.md#63-second-improvement-hybrid-bm25--dense) | ✅ |
| 7 | 2 | Keep/change reflection for Demo Day | [§7](./deliverables.md#task-7-next-steps) | ✅ |
| Final | 10 | 10-min-or-less Loom video (live demo + use case) | [deliverables.md top](./deliverables.md) | ✅ |
| Final | 10 | Written document answering every deliverable | [deliverables.md](./deliverables.md) | ✅ |
| Final | 0 | All relevant code | the repository (public) | ✅ |

> Status: complete. The CAS store, the 28-brief RAG corpus, the Chroma index, the **working LangGraph agent** (four tools + memory, through OpenRouter), the **Streamlit chat UI** (live and public at https://label-lens.streamlit.app/), the **evaluation harness** (gold set + LLM-judge + RAGAS + retrieval before/after tables), and the **≤10-minute Loom demo** are all done. Tasks 1-7 are answered in deliverables.md with recorded numbers, and the video link is at the top of deliverables.md.
...
- **Memory component**: done (product log / pantry, `agent/memory.py`).
