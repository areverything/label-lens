...
5. Additives with no recorded ruling (not in the reference set, or no status on \
file) must NEVER get their own line, bullet, or numbered entry, not even to say \
